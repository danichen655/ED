...
public:
	...
	*/
	...
	//Lineal
	void colarse(const T pringado, Queue<T> &other) { // El coste de esta funcion es O(N) siendo el N el tamanio de la cola.

		Nodo* ptr = _prim;
		Nodo* aux = ptr->_sig;

		Nodo* ptr2 = other._prim;
		Nodo* aux2 = other._ult;

		int i = 1;

		while (i < this->_numElems && ptr->_elem != pringado) {
		...
		this->_numElems += other._numElems;
